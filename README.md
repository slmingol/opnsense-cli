...
| **HAProxy** | haproxy:list, add, delete, route-add, route-delete, use-dns, use-ip, disable-resolver, inspect, apply, restart, frontend-list, frontend-add, frontend-delete, frontend-cert | Requires os-haproxy plugin |
